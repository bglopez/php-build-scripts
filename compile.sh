...
RANLIB=$RANLIB CFLAGS="-I$INSTALL_DIR/include $CFLAGS $FLAGS_LTO" CXXFLAGS="-I$INSTALL_DIR/include $CXXFLAGS $FLAGS_LTO" LDFLAGS="-I$INSTALL_DIR/lib $LDFLAGS $FLAGS_LTO" ./configure $PHP_OPTIMIZATION --prefix="$INSTALL_DIR" \
